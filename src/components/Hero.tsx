...
export default function Hero() {
  return (
    <>
      ...
      <nav className="relative z-20 flex w-full items-center justify-between bg-white px-4 py-3 shadow-sm sm:px-8 sm:py-5 lg:px-12">
        {/* Logo */}
      ...
      <main
        className="relative flex min-h-[60vh] sm:min-h-[75vh] w-full items-center overflow-hidden bg-cover bg-center bg-no-repeat"
      ...
      >
        ...
        <div className="relative z-10 w-full px-4 pb-12 pt-10 sm:px-8 sm:pb-20 sm:pt-16 lg:px-24">
          <div className="max-w-[640px]">
            ...
            {/* Eyebrow Pill */}
            <div className="mb-6 inline-flex items-center rounded-full border border-brand-ink/15 bg-white/95 py-2 pl-2.5 pr-4 text-xs sm:py-2.5 sm:pl-3 sm:pr-6 sm:text-sm font-medium text-brand-ink shadow-sm">
            ...
            <h1 className="mb-5 font-heading text-2xl sm:text-3xl font-bold leading-[1.1] tracking-tight text-brand-ink md:text-[2.75rem]">
              Connecting Exceptional Healthcare Talent with Organizations That Care
            </h1>

            <p className="mb-6 sm:mb-8 max-w-[500px] font-sans text-xs sm:text-sm font-medium leading-[1.6] text-brand-ink/80 md:text-[15px]">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <Link
                to="/request-talent"
                className="inline-flex items-center justify-center rounded bg-brand-primary px-6 py-2.5 text-sm sm:px-8 sm:py-3 sm:text-base font-bold text-white transition-colors hover:bg-brand-primary-dk focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2"
              >
                Request Talent
              </Link>
              <Link
                to="/explore-careers"
                className="inline-flex items-center justify-center rounded border border-brand-primary bg-white px-6 py-2.5 text-sm sm:px-8 sm:py-3 sm:text-base font-bold text-brand-primary transition-colors hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2"
              >
                Explore Careers
              </Link>
            </div>
